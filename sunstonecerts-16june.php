...
<div class="col-sm-6 mg-b-50">
  ...
  <div class="form-group">
    <div class="col-sm-12">
      <input type="number" class="form-control" name="mobile" id="inputPassword3" placeholder="Mobile Number" required>
    </div>
  </div>
          ...
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingOne">
              <h4 class="panel-title">
                ...
                </span><i class="glyphicon glyphicon-plus pull-right "></i>
              </h4>
            </div>
...
<div class="modal-body">
  ...
  <div class="form-group">
    <div class="col-sm-12">
      <input type="number" class="form-control" id="" name="mobile" placeholder="Mobile Number" required>
    </div>
  </div>
