    ...
    <div class="container no-side-padding" id="student_interviews">
      <div class="main col-md-12">
        ...
        <div class="col-md-10 col-md-offset-1">
          ...
          <div class="heading no-side-padding bold si">Student Profiles</div>
          <hr class="heading_line"> 
          <div class="pd-t-20"></div>
        </div>
       <div class="col-md-5 col-md-offset-1 col-sm-4">
          <iframe width="100%" height="350" class="pd-t-20" src="https://www.youtube.com/embed/W0xsDEcPkO8" frameborder="0" allowfullscreen></iframe>
        </div>
        <div class="col-md-5 col-sm-8 pd-t-40 pd-b-30 mg-t-50 quote_section">
          <p class="text-left" style="font-family: 'nexa_bold'!important;color:#333;padding:0em 1em; font-size:1.2em; ">My manager noticed the change in me. He said - </p>
            <p style="padding:0em 0.5em 1em;color:#f8872d;font-size:18px;font-weight:500;"><i class="fa fa-quote-left fa-fw fa-2x"></i><i> Rohit I can see the different in the way you are facing the problem, your understanding of the business!</i>
          </p>
          <p class="text-left" style="font-family: 'nexa_bold'!important;color:#333;padding:0em 1em;font-size:1.2em; ">When my manager decided to move up the ladder, he elevated me to the Project Management position in the organization!</p>
          <p class="text-right" style="font-family: 'nexa_bold'!important;color:#333;padding:0em 1em; "> Rohit Mathur</p>
          <p class="text-right" style="font-family: 'nexa_bold'!important;color:#333;padding:0em 1em;"> Class of Fall 2014</p>
        </div>
        <div class="col-md-10 col-md-offset-1 col-sm-12  pd-t-20">
        <hr>
          <p style="font-weight:500;">
            Read more about our students, their profiles and experiences as participants in the Sunstone program by <span class="orange_color">clicking on their photos</span> below.
            <br>Our complete student list is available <a style="text-decoration:underline;" class="orange_color" href="https://www.linkedin.com/edu/alumni?id=43428&trk=edu-up-nav-menu-alumni">here.</a>
          </p>
        </div>
...
getting served well”</h4>" >
          ...
          <li>
            <a class="urlmodal21" data-target="#myModal21" data-largesrc="img/SI/thumbs/21.jpg" data-title="Vakul Agarwal" data-description="
              ...
              <h4><strong>Current Role:</strong> <em> Technical Product Manager, Amazon </em></h4>
             ...
             <!--  <span class="desig_strip">
                  ...
                  <div class="designation">Technical Product Manager, Amazon</div> -->
          ...
          <li>
            <a class="urlmodal22" data-target="#myModal22" data-largesrc="img/SI/thumbs/22.jpg" data-title="Niharika Sharma" data-description="
              ...
              <h4>“Sunstone and senior management at Oracle helped me create this opportunity”</h4>" >
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
             ...
             <p> Yes there been and a major change has been in how I present my ideas. How I now handle mails, presentations and pitch that I’m making. I have also started realizing much better why my seniors make some business decisions which might not look correct in first look. Currently, I’m in the process of identifying opportunities to contribute more to organization, where I can use the knowledge gained in Sunstone.</p>
...
program”</h2>
             ...
             <p> First thing professionals need to understand is that management programs are not the short cut to job change or switch to management roles. They will give you the knowledge on the gamut of business concepts, make you understand how decisions are made in business and develop you into a better informed professional. The magic lies in how you as a professional, use this knowledge, and network developed by interacting with students, faculty and guest speakers, to define your own career path.</p>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4>What is your vision for yourself, personal as well as professional?</h4>
             <p> I want to become my own boss but not the bossing around kind! I would like to create open and transparent culture within my organization or my team by leading from the front. My vision is to serve people with highest level of integrity by putting hard work. And my time at Sunstone has inspired me to revisit the dream of my own disruptive learning venture.</p>
              ...
              <h4>Which faculty has inspired you the most and why?</h4>
             <p> Before starting the program, I envisioned this as an opportunity to put myself through a process or complete journey of business. Each and every faculty contributed to my successful journey. Each one of them were very approachable, especially Dinesh and Tapan, with whom I could share what I want to do, and they have taken personal interest to guide me all the time. Many unanswered questions were answered on-line and off-line. Rajul inspired me live on my dream once again.</p>
             ...
             <p> Honestly speaking, it is SBS that gave me opportunities to come so far, with vast blended practical learning, with greater flexibility and apt push needed to finish assignments and projects. I believe it would not have been the case with any other school. Yes, sometime it is very difficult to manage workload given the type of capacity I work within my current organization, but teamwork helped to manage extreme pressures.</p>

             <p> In addition, usage of alternative communications, forums, off-line & on-line platforms helped to manage my workload very effectively. I feel like learning while sleeping or driving and my faculties and fellows have been there every step of the way to help us learn 24×7!</p>
              <h2>“This has  inspired me to revisit the dream of my own disruptive learning venture”</h2>
              <h4>As you complete each level, what impact of SBS learning have you experienced on the quality of your work? Have others noticed this shift too?</h4>
             <p> Now I am more confident and organized to manage both technical and management responsibilities. Every time I finish a course, I feel richer, more confident and ready to take on bigger responsibilities outside technical roles, be it operations, strategy or product management. One of the greatest learning would be on leadership skills, just by just observing & following my young and dynamic faculty. I have also learned to tell the story of a business problem in front of internal and external stake holders. SBS taught me how to analyze business problems with broader prospective and develop solutions.</p>

            <p>  My supervisors are well aware of my learning initiatives and they value my progress. I am getting opportunities to work with critical strategic initiatives of my organization which very few privileged colleagues would dream at my age. My association with SBS is highly appreciated by my immediate supervisor who is constantly pushing me to develop cases, for research collaboration, with our innovation labs, using my learning from SBS.</p>

            <p>  This has been wonderful and rich journey for last one year.</p>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
             ...
             <p> The biggest improvement I found in myself was in my ability to network professionally. This skill is highly applicable in my current role where I have to continuously network with people to explore opportunities, negotiate, collaborate.</p>

              <h4>What is your advice for techies who want to move to management positions?</h4>
              <p>Senior management positions involves the ability to assimilate information, to take decisions fairly quickly, and to strategize for the future. It also requires you to meet, greet and negotiate with a lot of people both within the company and outside. Finally, it requires the ability to present your thoughts clearly. Good presentation skills come in very handy in this role.</p>

            <p>  So, my two cents is to constantly invest in self development.</p>
...
and to strategize for the future”</h2>
              <h4>What is your advice for professionals who are looking for part time management programs?</h4>
             <p> A lot of MBA aspirants look at part time programs with misplaced motives. It’s not a mystical key to a fancy job which your full time MBA friend might be doing. Part time programs are primarily aimed at personal development, and the fact that you chose to pursue it demonstrates your personal commitment to fast-track your career. You come out much richer in business understanding, are much more connected by way of a network of friends, and are rejuvenated with self confidence. Completing such programs do requires a lot of motivation, discipline and personal sacrifices, all of which are acknowledged by the industry in the long run.</p>

              <h4>Do you feel it is important for techies to understand business skills?</h4>
             <p> Absolutely! Having a set of business skills will help understand “why” certain things are happening and “why” certain things are extremely important for business to keep running. It can be as trivial as filling time-sheets accurately or as significant as getting your next major release out on time. Without that appreciation, I have seen engineers getting overwhelmed, confused and frustrated.</p>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4>What would you have missed if you did not do this program?</h4>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
			  ...
			  <h2>"Learn to develop big picture thinking"</h2>
          </div>
        </div>
      </div>
...
consider him/her for a role in my team"</h2>
              ...
              I think I would have been doing things in same way, which would surely have been sub-optimal for my personal and professional growth. I would definitely have missed the go-getter attitude. It’s indeed a big transformation.
			   ...
			   <h4>What is your vision for yourself?</h4>
             My vision is to be successful entrepreneur.
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              Project Manager @ Greytrix India Pvt. Ltd.
			   ...
			   <h4>What is it that you aspire to do?</h4>
              I aspire to get into business consulting
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
             ...
             <p> Once we had identified the kind of roles I should go for, I contacted Mritunjay – A Product Management expert at Sunstone who helped me build effective resume through multiple reviews and a sound pitch through mock interviews.</p>
             <p> Interestingly the opportunity at Cvent came through one of my peers at Sunstone. I happened to mention to him that I was looking for a job and he mentioned that his company Cvent is looking for product managers. He passed my resume in his company and after few rounds of interviews I was offered this role.</p>
              <h4>What is your long term vision for yourself?</h4>
              ...
              <h4>What are top 3 lessons learnt at Sunstone so far?</h4>
             <p> Business is complex; our job is to make it simple.</p>
             <p> Managing Expectation & Perception are key to success.</p>
             <p> Learn, Implement & Manage Risk – Have No Fear</p>
             <h4> You are pursuing this program along with your job. How do you manage your time?</h4>
...
your results are useless"</h2>
              ...
              <p><h6>Network, network and network: </h6>I think if I have to take out one single learning from the whole program then it has to be the importance of networking. Its totally unbelievable how doors suddenly start opening as you widen your network circle. Rajul really pushed hard to drive home the importance of networking and can I only say that his effort was totally worth it.</p>
              <p><h6>Build a story for everything:</h6> You can do deep analysis of a problem, gather extensive data, read all references, but unless you are able to synthesize the results and present them in a way that the listener can understand, all your results are useless. Story building comes to the rescue here and we extensively used it to reason about the problem and present the solution. Its not just a presentation tool but a whole different way to think about how problems need to be approached.</p>
              <p><h6>Leave your comfort zone for the magic to happen:</h6> Working for years in the same job profile and doing the same type of work gives us a sense of security because we become so expert in our work that any problem is just a child’s play. There is no hard problem which we can not solve. This is our comfort zone. There is no uncertainty in one’s comfort zone, and life is very predictable. Unfortunately this predictability also makes life very boring. There is nothing new. And even the security that the comfort zone gives is just an illusion. Technology is changing so fast that you wouldn’t even realize and freshers coming out of college will outsmart you while you will still be stuck with the age old work which suddenly no one needs. Faculty at Sunstone was really able to coax us to get out of our comfort zone and explore the world by trying out new opportunities.</p>
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              I am Engineering and Product Manager with Johnson Control
			   ...
			   <h4>Do you feel that the engineers in a team can perform better if they are business competent?</h4>
             Absolutely Yes. Every individual is going to perform any task better if they know the purpose of accomplishing the task. Good business education will make you understand the eco system better – your organization’s and client’s business, challenges that leaders face etc. This helps you understand your manager and above, add more value and get better growth.
              ...
              <p><h6>Long term benefits:</h6> I want to grow vertically and with this program I am able to generate better growth opportunities for my self.</p>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4>What is your current role?</h4>
             As a Senior Manager, QAI India Limited, I’m responsible to develop International geographies for the company and source clients who are interested in achieving excellence in their processes.
              <h4>What is your advice to everyone who is considering doing an MBA program?</h4>
            ...
            <h4>What impressed you most about Sunstone?</h4>
           ​<p> Amongst several things that I liked at Sunstone, two of them stand out :</p>

          ​<p> 1. People – ​always ready to help – ​faculty, management team, peers are supportive, at any point of time help is available. Faculty is helpful in resolving doubts, guiding when I am stuck to being inspirational</p>
           ​<p>2. Pedagogy – exceptional – The method of learning is by solving real business problems in a hands-on manner. I have also learnt a lot from other students while solving the assignments as a team.</p>
           <h4> What would you have missed if you had not done the Sunstone program?</h4>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4>When I started Sunstone program, my intent was to evolve my thought process.</h4>
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              I was a senior software engineer at Oracle.
			   ...
			   <h4>What is your current role?</h4>
              I am a Senior Product Manager at Oracle now.
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              After a year at Sunstone, my perspective about things around me has changed. I have a more positive mind-set now and can understand things from the perspective of other side as well; I can now connect dots and understand the big picture.
			   ...
			   <h4>What was I doing when I joined Sunstone?</h4>
             Before joining Sunstone, I had around 10 years of experience in technology industry. At the time I joined the program, I was working as a Technical Development Manager at Fidelity Worldwide Investments. I was leading a team of around 10 developers in handling the operations of the largest mutual fund E-commerce site in UK. As a manager, I was responsible for technical designing of the site and leading the development team. I was also the primary contact between the business side and the development / delivery team.
