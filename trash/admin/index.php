...
//echo '<pre>';print_r($_SESSION);
		if(isset($_POST['login']))
		{
			...
			$query_login =" SELECT * FROM admin_login where admin_user_name= '$admin_user_name' and admin_password='$admin_password' and user_type='admin_sunstone'"; 
