      ...
      <div class="container" id="menu_section">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right" id="nav_fix">
            ...
            <li class="pull-right pd-t-20 orange_color pointer pd-r-20"data-toggle="modal" data-target="#myModalr"><i class="fa fa-external-link fa-fw"></i> Download brochure to get Program details</li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                  <li><a href="po.php">PGPM Overview</a>
                  <hr class="orange_1 ">
                  </li>
                  <li>
