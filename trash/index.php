      ...
      <div class="container header_section">
        <div class="row">
          <div class="col-md-12" style="padding-bottom:70px;">
            ...
            <span class="pd-l-30 pd-r-30">Move to next level</span>
           <span class="pd-l-30 pd-r-30">Increase your salary </span>
            <span class="pd-l-30 pd-r-30">Change to management role</span>
            </div>
