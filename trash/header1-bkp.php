    ...
    <div class="navbar navbar-inverse navbar-fixed-top menu" role="navigation">
      <div class="container" id="menu_section">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="http://sunstone.in/new/"><img src="img/logo.png" width="250px"></a>
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right" id="nav_fix">
            ...
            <li class="pull-right pd-t-20 orange_color pointer pd-r-20 hide_links" data-toggle="modal" data-target="#myModalr"><i class="fa fa-external-link fa-fw"></i> Download brochure to get Program details</li>
            </ul>
           ...
           <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                  ...
                  <li>
                  <a href="pbl">Problem Based Learning</a>
                  <hr class="orange_1 ">
                  </li>
                  <li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                  ...
                  <li>
                  <a href="ind_speak">Industry Speakers</a>
                  <hr class="orange_1 ">
                  </li>
              </ul>
            </li>
