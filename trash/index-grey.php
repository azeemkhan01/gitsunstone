...
?>
    ...
    <body>
        ...
        <![endif]-->
    <div class="navbar navbar-inverse navbar-inverse1 navbar-fixed-top menu" role="navigation">
    ...
    <!-- Main jumbotron for a primary marketing message or call to action -->
      ...
      <div class="container header_section header_section1">
        <div class="row">
