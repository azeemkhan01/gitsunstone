  ...
  <div id="wrapper">
     ...
     <div id="page-wrapper">
        <div class="col-lg-12 pd-t-20">
                <span style="font-size:30px;" class="page-header">ATTEND WEB SESSION</span>
                                ...
                                <div class="table-responsive">
                                  <div style="font-family: fantasy;float:right;">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <?php
                                              $query = "SELECT * FROM attend_web_session ORDER BY id ASC";
                                            ...
                                            ?>
                                                  <tr class="odd gradeX">
                                                      ...
                                                      <td>
                                                      <?php 
                                                       echo '<a href="web_session_info.php?id='.$values["id"].'" class="" style="cursor:pointer">
                                                        ...
                                                        ?>
                                                        &nbsp;&nbsp;
                                                        <a name="<?php echo $values['id']; ?>" class="deleteWebUser" style="cursor:pointer">
