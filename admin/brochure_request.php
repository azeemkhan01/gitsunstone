...
<head>
   ...
   <!-- Script to delete category -->
    <script type="text/javascript" src="js/deleteBrochureUser.js"></script>
  ...
  <div id="wrapper">
     ...
     <div id="page-wrapper">
          <div class="col-lg-12 pd-t-20">
              ...
              <span style="float:right;"><a href="csv/brochure_export.php"style="color:#fff;" ><button class="btn btn-danger" id="download"/>Download CSV</a></span>
          </div>
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="table-responsive">
                                  <div style="font-family: fantasy;float:right;">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <?php
                                              $query = "SELECT * FROM download_brochure ORDER BY id ASC";
                                            ...
                                            ?>
                                                  <tr class="odd gradeX">
                                                      ...
                                                      <td>
                                                      <?php 
                                                       echo '<a href="brochure_request_info.php?id='.$values["id"].'" class="" style="cursor:pointer">
                                                        ...
                                                        ?>
                                                        &nbsp;&nbsp;
                                                        <a name="<?php echo $values['id']; ?>" class="deleteUser" style="cursor:pointer">
