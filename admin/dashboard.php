                        ...
                        <div class="panel panel-blue">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <?php
                                            $query7 = "SELECT * FROM registration_info";
                                            $result7 = mysql_query($query7);
                                            $value7 = mysql_num_rows($result7);
                                        ?>
                                        <div class="huge"><?php echo $value7; ?></div>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <?php
                                            $count_query_pages = "SELECT * FROM pages";
                                            $count_result_pages = mysql_query($count_query_pages);
                                            $count_value_pages = mysql_num_rows($count_result_pages);
                                        ?>
                                        <div class="huge"><?php echo $count_value_pages; ?></div>
                                        <div>PAGES</div>
                                    </div>
                                </div>
                            </div>
