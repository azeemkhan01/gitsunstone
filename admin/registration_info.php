...
<head>
   ...
   <!-- Script to delete category -->
    <script type="text/javascript" src="js/delRegisterUsers.js"></script>
  ...
  <div id="wrapper">
     ...
     <div id="page-wrapper">
          <div class="col-lg-12 pd-t-20">
              <span style="font-size:30px;" class="page-header">REGISTRATION INFO</span>
              <span style="float:right;"><a href="csv/register_csv.php"style="color:#fff;" ><button class="btn btn-danger" id="download"/>Download CSV</a></span>
          </div>
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="table-responsive">
                                  <div style="font-family: fantasy;float:right;">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <?php
                                              $query = "SELECT * FROM registration ORDER BY created_on DESC";
                                            ...
                                            ?>
                                                  <tr class="odd gradeX">
                                                      ...
                                                      <td>
                                                          <a name="<?php echo $values['id']; ?>" class="deleteRegUser" style="cursor:pointer">
