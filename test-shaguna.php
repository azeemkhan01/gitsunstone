                ...
                <li id="level1">
                  ...
                  <div class="cbp-ntcontent">
                    <ul class="cbp-ntsubaccordion">
                      ...
                      <!-- Subject-2 -->
                      <li>
                        <h4 class="cbp-nttrigger">Financial Statement Analysis</h4>
                        <div class="cbp-ntcontent">
                      ...
                      <!-- Subject-3 - Networking missing --> 
                        <li>
                          <h4 class="cbp-nttrigger">Networking</h4>
                        </li>
                      ...
                      <!-- Subject-8 -->
                      <li>
                        <h4 class="cbp-nttrigger">Economics Simulation</h4>
<!--                        <div class="cbp-ntcontent">
                ...
                <li id="level2">
                  ...
                  <div class="cbp-ntcontent">
                    <ul class="cbp-ntsubaccordion">
                      ...
                      <!-- Subject-3 -->
                      <li>
                        <h4 class="cbp-nttrigger">Micro Economics</h4>
                        <div class="cbp-ntcontent">
                          <p>We live in a world of scarce resources. Yet how well we utilize these resources depends on day-to-day decisions that we make. The economic concept of “supply and demand” helps us understand the decisions of ourselves and others.
                          <br><br>In this module, students learn the basics of sound decision-making by examining choices and scarcity, including:
                        ...
                        <!-- Subject-5 -->
                            ...
                            <!-- Subject-8 -->
                            <li>
                              <h4 class="cbp-nttrigger">Digital Marketing</h4>
                            </li>
                            ...
                            <!-- Subject-10 -->
                            <li>
                              <h4 class="cbp-nttrigger">Services Leadership</h4>
                            </li>
                      ...
                      <li id="level31">
                       ...
                       PGPM Level - 3 <!-- Business Expertise -->
                        ...
                        <li>
                          ...
                          <div class="cbp-ntcontent">
                          <p>This module continues and deepens the themes from Growth Strategies – I.  </p>
                          </div>
                        </li>
                        ...
                        <!-- Subject-2 -->
                        <li>
                          <h4 class="cbp-nttrigger">Mock Interview</h4>
                        </li>


                        <!-- Subject-3 -->
                        <li>
                          <h4 class="cbp-nttrigger">Board Room</h4>
                        </li>     
                        ...
                        <!-- Subject-8 -->
                        <li>
                          <h4 class="cbp-nttrigger">Lessons in Leadership</h4>
                        </li>
                        
                        <!-- Subject-9 -->
                        <li>
                          <h4 class="cbp-nttrigger">Growth Hacking</h4>
                        </li>
                        
                        <!-- Subject-10 -->
                        <li>
                          <h4 class="cbp-nttrigger">Live Capstone Project</h4>
                        </li>
