...
// $status=$_POST["status"];
// $udf1 = $_POST['udf1'];
$course_name = "Finance for Non-Finance Managers";
$amount = 14000;
$contact_no = "895959659652";
$firstname = "Dev";
 $email="devedu285@gmail.com";
 $txnid="8748541564";
 $status="success";
 $udf1="Finance for Non-Finance Managers";
...
$merchant_id  = $_POST['key'];
          ...
          $query = "INSERT INTO payment_info(firstname,email,contact_no,course_name,amount,txnid,bank,transaction_time,posted_hash,key_value,salt_value,status)
                    VALUES('$firstname','$email','$contact_no','$udf1','$amount','$txnid','$bank','$transaction_time','$transaction_time','$posted_hash','$salt','$status')";
              ...
              <a href="www.sunstone.in">
                <img src="http://sunstone.in/internal/wp-content/uploads/2011/11/logo.jpg" alt="Sunstone" style="border: none;">
                    ...
                    <div style="margin-top:15px;color:#333;line-height:30px;padding:10px;">
                         ...
                         <div style="font-size:12pt">Course Name '. $udf1 .'</div>
