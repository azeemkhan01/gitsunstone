            ...
            <div class="modal-body pd-b-20">
              ...
              <form class="form-horizontal pd-t-20 form23" method="post" data-toggle="validator" role="form">
                ...
                <div class="form-group">
                  ...
                  <div class=" ">
                    <input type="email" name="lemail" id="lemail" data-error="Please Fill Email" class="form-control" id="" required>
                ...
                <div class="form-group">
                  ...
                  <div class="">
                    <input type="password" name="lpassword" id="lpassword" data-error="Please Fill Password" class="form-control" id="" required>
                    <div class="help-block with-errors"></div>
                  </div>
                </div>
          ...
          <div class="modal-content register-content">
           ...
           <?php if ($_SESSION["is_register"] != TRUE) { ?>
            <div class="modal-body register-body">
              <form class="form-horizontal form11" data-toggle="validator" role="form" >
              <div class="form-group"><h3>REGISTER <?php echo $_SESSION["is_logged_in"]; ?></h3></div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="" class="control-label">Captcha <font color="#FF0000">*</font></label>
