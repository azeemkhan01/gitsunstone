          ...
          <div class="col-md-4 col-sm-4 text-center blocks">
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                <!-- <span> Be in Demand</span> -->
                <div class="heading" style="font-size:1.7em;">Be in Demand</div>
                <hr class="red">
                <div class="pd-t-20 subheading">
                  Gain practical skills and project experiences through intense Nano degrees. Only upskilling management program approved by Govt of India to help you get new roles, promotions and increase in salary.
                </div>
          ...
          <div class="col-md-4  col-sm-4 text-center blocks">
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                ...
                <hr class="red">
                <div class="pd-t-20 subheading">
                  nano-MBA Programs designed and delivered NOT by academicians or professors, but BY senior industry leaders - CXOs and successful entrepreneurs. Unlimited mentoring and coaching by industry experts.
                </div>
                <div class="row pd-t-10">
                </div>
              </div>
          ...
          <div class="col-md-4 col-sm-4 text-center blocks">
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                ...
                <div class="heading" style="font-size:1.7em;">Live Online Classes</div>
                <hr class="red">
                <div class="pd-t-20 subheading">
                  12 Hrs/week of online learning including LIVE online sessions, coaching, and group work. High interaction to facilitate learning and building a strong network for life.
                </div>
                <div class="row pd-t-10">
                </div>
              </div>
 ...
 <!--//////Code edited by Aruna ends//////-->  
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      var referFriend = $('#referFriend').val();
      if(broId){
    ...
    <!-- Main jumbotron for a primary marketing message or call to action -->
      <?php 
        ...
        $referFriend = $_GET['referFriend'];
    ?>
     <input type="hidden" value="<?php echo $bro_id; ?>" id="bro_id"> 
     <input type="hidden" value="<?php echo $referFriend; ?>" id="referFriend"> 
